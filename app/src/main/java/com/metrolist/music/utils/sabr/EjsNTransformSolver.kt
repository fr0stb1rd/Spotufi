...
object EjsNTransformSolver {
    ...
    class SolverWebView private constructor(
        ...
        private val solverCacheDir = File(context.cacheDir, "ejs_solver")
        ...
        init {
            ...
            val assetLoader = WebViewAssetLoader.Builder()
                .addPathHandler("/ejs_solver/", InternalStoragePathHandler(context, solverCacheDir))
                .build()
        ...
        private fun loadSolverAndPlayer() {
            ...
            for (file in listOf("meriyah.js", "astring.js", "yt.solver.core.js")) {
                assetManager.open("solver/$file").use { input ->
                    File(solverCacheDir, file).outputStream().use { output ->
                        input.copyTo(output)
                    }
                }
            }
    ...
    try {
        ...
        EjsBridge.onNError(e.toString() + '\n' + (e.stack || ''));
            ...
            webView.loadDataWithBaseURL(
                "http://appassets.androidplatform.net/ejs_solver/",
